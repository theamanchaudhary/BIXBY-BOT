...
t_size, is_subscribed, get_poster, search_gagala, temp, get_settings, save_group_settings
from database.users_chats_db import db
from database.ia_filterdb import Media, get_file_details, get_search_results
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):        
        ...
        buttons = [[
            ...
            InlineKeyboardButton("📢 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 📢", url="https://t.me/DX_MODS1")
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('SOURCE CODE', url='https://github.com/DX-MODS/BixbyAutoFilter')
            ],[
